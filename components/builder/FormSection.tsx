            ...
            <div className="flex justify-between items-center mb-3">
                ...
                {onRemove && (
                    <button
                        type="button"
                        onClick={onRemove}
                        className="p-1 rounded-full text-slate-400 hover:bg-rose-500/10 hover:text-rose-500 focus:outline-none focus:ring-2 focus:ring-rose-500/50 transition-colors"
