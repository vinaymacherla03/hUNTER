...
export const AiOrbIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 shadow-lg shadow-emerald-500/40 flex items-center justify-center relative overflow-hidden border border-white/20">
...
export const MagicPenIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-lg shadow-emerald-500/30 flex items-center justify-center border border-white/20 transform -rotate-6">
...
export const StyleIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-400 to-rose-600 shadow-lg shadow-rose-500/30 flex items-center justify-center border border-white/20 transform rotate-3">
...
export const TemplatesIcon = ({ className }: { className?: string }) => (
    <IconWrapper className={className}>
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-lg shadow-emerald-500/30 flex items-center justify-center border border-white/20 transform -rotate-3">
